var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			"A: Wow ajoyib o'yin ekan.",
			"Y: Ha ajoyib oyin.",
			"A: Buni qanday yaratishibdi?",
			"Y: Html va Javascript dasturlash tillarida.",
			"A: Bu dasturlash tillarini qayerdan o'rgansam bo'ladi?",
			"Y: Uzbekcoders orqali o'rganishing mumkin. Uzbekcodersda bepul o'rgatiladi.",
			"A: Raxmat."
		];
