var ytOptionLayer = (function () {
	function ytOptionLayer () {
		...
		s.placeInfoList = [
			{name : "Jarlik", data : "street_canyon"},
			{name : "Shahar", data : "street_city"},
			{name : "Sahro", data : "street_desert"},
			{name : "Yashil maydon", data : "street_grass"},
			{name : "Qorli maydon", data : "street_snow"},
			{name : "Suvli maydon", data : "street_water"}
		];
